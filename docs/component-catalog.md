...
decks/github-enterprise-platform/components/ # GitHub-specific components
```
...
The GitHub Enterprise deck keeps these components locally because they depend on
GitHub, GHAS, Copilot, or a specific CTA:
...
generalized into brand-neutral components.
