...
defineProps({
  ariaLabel: { type: String, default: 'Escena 3D de formas' },
  kicker: { type: String, default: '3D stage' },
  title: { type: String, default: 'Formas modulares' },
  detail: { type: String, default: 'Una escena ligera para slides de alto impacto.' }
})
